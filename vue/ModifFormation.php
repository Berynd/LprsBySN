...
<main class="main">
    ...
    <div class="content">
        ...
        <form method="POST" action="../src/traitement/Formation/TraitementModifFormation.php" class="add-form">
            <div class="form-group">
                <label for="titre">Titre</label>
                <input type="text" id="titre" name="titre" required>
            </div
            <button type="submit" class="btn-submit">Modifier la formation</button>
        </form>
    </div>
    <footer class="footer">
