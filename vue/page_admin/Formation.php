...
<div class="admin-container">
    ...
    <table>
        ...
        <?php if (!empty($listeFormation)) : ?>
            <?php foreach ($listeFormation as $user): ?>
                <tr>
                    <td><?= htmlspecialchars($user['nom']) ?></td>
                    <td><?= htmlspecialchars($user['adresse']) ?></td>
                    <td><?= htmlspecialchars($user['site_web']) ?></td>
                    <td>
                        <button class="btn-action btn-modifier" onclick="window.location.href='../page_admin/ModifierFormation.php?id=<?= $user['id_formation'] ?>'">Modifier</button>
                        <button class="btn-action btn-supprimer" onclick="if(confirm('Supprimer cette Formation ?')) window.location.href='../src/traitement/Formation/TraitementSuppresionFormation.php?id=<?= $user['id_formation'] ?>'">Supprimer</button>
