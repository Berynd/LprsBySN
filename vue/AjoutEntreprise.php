...
<main class="main">
    ...
    <div class="content">
        <h2 class="form-title">🏢 Ajouter une entreprise</h2>
        <form method="POST" action="../src/traitement/Entreprise/TraitementAjoutEntreprise.php" class="add-form">
            ...
            <div class="form-group">
                ...
                <input type="url" id="site_web" name="site_web" placeholder="https://exemple.com" required>
            </div>
            <button type="submit" class="btn-submit">Ajouter l’entreprise</button>
        </form>
    </div>
